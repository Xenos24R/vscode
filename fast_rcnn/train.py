...
def create_image_label_path_generator(synthetic_dataset_path):
    image_num = 8000
    image_label_paths = [(os.path.join(synthetic_dataset_path, "E:/synthetic_dataset/image/%d.jpg" %(idx+1)),
                        os.path.join(synthetic_dataset_path, "E:/synthetic_dataset/imageAno/%d.txt"%(idx+1))) for idx in range(image_num)]
    while True:
